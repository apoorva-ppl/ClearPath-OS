...
// Merge the parallelism fix into the existing webpack configure
const existingConfigure = webpackConfig.webpack.configure;
webpackConfig.webpack.configure = (config, context) => {
  config = existingConfigure(config, context);
